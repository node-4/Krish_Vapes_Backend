...
const storage = new CloudinaryStorage({
        cloudinary: cloudinary, params: {
                folder: "images/Product", allowed_formats: ["jpg", "jpeg", "webp", "mp4", "mp3", "png", "PNG", "xlsx", "xls", "pdf", "PDF"]
        },
});
...
const storage1 = new CloudinaryStorage({
        cloudinary: cloudinary, params: {
                folder: "images/banner", allowed_formats: ["jpg", "jpeg", "webp", "mp4", "mp3", "png", "PNG", "xlsx", "xls", "pdf", "PDF"]
        },
});
const upload1 = multer({ storage: storage1 });
const storage2 = new CloudinaryStorage({
        cloudinary: cloudinary, params: {
                folder: "images/blog", allowed_formats: ["jpg", "jpeg", "webp", "mp4", "mp3", "png", "PNG", "xlsx", "xls", "pdf", "PDF"]
        },
});
const upload2 = multer({ storage: storage2 });
const storage3 = new CloudinaryStorage({
        cloudinary: cloudinary, params: {
                folder: "images/about", allowed_formats: ["jpg", "jpeg", "webp", "mp4", "mp3", "png", "PNG", "xlsx", "xls", "pdf", "PDF"]
        },
});
...
const storage4 = new CloudinaryStorage({
        cloudinary: cloudinary, params: {
                folder: "images/category", allowed_formats: ["jpg", "jpeg", "webp", "mp4", "mp3", "png", "PNG", "xlsx", "xls", "pdf", "PDF"]
        },
});
